...
def convert():
    geojson = osm2geojson.xml2geojson(request.data, filter_used_refs=False, log_level='ERROR')
...
def map():
    ...
    osm = response.text
    xmltogeojson = osm2geojson.xml2geojson(osm, filter_used_refs=False, log_level='ERROR')
